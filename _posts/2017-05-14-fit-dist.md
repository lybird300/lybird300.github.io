...
<pre><code>
emp_val_lt999quant = emp_val_lt999quant[emp_val_lt999quant > 0]
fitdist(emp_val_lt999quant[emp_val_lt999quant < 1], "beta")  #Option 1
fitdist((emp_val_lt999quant - min(emp_val_lt999quant)*1.01)/(max(emp_val_lt999quant)*1.01 - min(emp_val_lt999quant)*1.01), "beta") #Option 2
