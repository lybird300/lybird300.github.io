...
<h2>Play with CHAT by yourself</h2>
...
<li>Change the working directory to wherever you put the "TestDebug" folder (Debug configuration --> Arguments tab --> Working directory (click on "Other" and specify the path of the folder)</li>
</ul>
If you prefer your own test data, please create the following input files (all required) and format them as instructed.
<ul>
<li></li>
</ul>
