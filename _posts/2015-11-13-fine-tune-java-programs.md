...
I figure it means I need to set up log4j.properties and log4j.xml files if I want to keep using apache flink. OK. I have no clue how to do that. Shame on me. Let's take a look at <a href="http://logging.apache.org/log4j/1.2/manual.html">log4j manual</a>. 
<h2>References</h2>
<ul>
