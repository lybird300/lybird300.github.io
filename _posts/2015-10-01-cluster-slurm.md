...
<li>Cancel all pending jobs belonging to a specific user</li>
<pre><code>scancel -t PENDING -u <username></code></pre>
<li>Also note that "scancel" job array big ID will cancel all sub jobs in the array</li>
