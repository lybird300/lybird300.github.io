...
chromosomes. One parent’s contribution is a combination of its two <a href="http://www.phschool.com/science/biology_place/labbench/lab3/homologs.html">homologous chromosomes</a> when they undergo recombination. In the absence of recombination, the entire genome would correspond to a single genealogical tree. With recombination, only closely linked sites (on the same chromosome) tend to have the same genealogical tree. The extent to which the histories of different sites are correlated (i.e., their genealogical trees are correlated) depends on the recombinational distance between them. As recombination approaches infinity (back in time), the genealogies of unlinked loci (genetically distant sites on the same chromosome or different chromosomes) are conditionally independent. As we proceed from one end of the sequence to the other, it is like walking through a forest.
